...
On first launch, BookBoss detects that no admin account exists and prompts you to create one.
...
- [Database Configuration](database.md) — choose and configure your database backend
